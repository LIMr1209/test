...
def cloth_color(image_path='衣服/10.jpg', expected_size=40, in_clusters=3, out_clusters=3, final_size=300):
    ...
    #     # initial_image = initial_image[653:1347,765:2130]
    #     # cv2.imshow('ai',initial_image)
    #     # cv2.waitKey(0)
    #
    ...
    #         color_weight = int(math.ceil(proportions[i] * final_height / float(total_color)))
    #         color_list.append((color_weight, color))
    #     print(color_list)
